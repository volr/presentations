...
\makeatother
    ...
    \section{Computational modelling for the cognitive
sciences}\label{computational-modelling-for-the-cognitive-sciences}
...
\item
  ...
  \tightlist
  \item
    Unit for Cognitive Neuroscience in Copenhagen (UCN) are studying
    plasticity and rehabilitation\\
  \item
    Experiment iteration times typically in the order of months
    (excluding planning etc.)
  \end{itemize}
\item
  Simulations/emulations of neural systems are exhibiting biologically
...
\tightlist
\item
  Goal: Build a platform for the inquiries of the cognitive
  neuroscientists

  \begin{itemize}
  \tightlist
  \item
    Research objective: Recreate expected behaviour for lesioned systems
    in simulations
  \end{itemize}
\item
  Background
  ...
  \tightlist
  \item
    Jesper Mogensen at UCN developed modular models that can be examined
    computationally
  \item
    'Missing link' between complex neural simulations/neuromorphic
    hardware and non-programmers
  \end{itemize}
\item
  Benefits
  ...
  \item
    Futher understanding of the relation between computation and
    cognition
  \end{itemize}
\end{itemize}
...
\tightlist
\item
  Precedural domain-specific language (DSL) for consistent and concise
  modelling
